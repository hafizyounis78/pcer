...
<head>
    <meta charset="utf-8" />
    <title>Metronic Admin RTL Theme #7 | Dashboard</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1" name="viewport" />
    <meta content="Preview page of Metronic Admin RTL Theme #7 for dashboard & statistics" name="description" />
    ...
    <link href="{{url('/')}}/assets/layouts/layout7/css/layout-rtl.min.css" rel="stylesheet" type="text/css" />
    <link href="{{url('/')}}/assets/layouts/layout7/css/custom-rtl.min.css" rel="stylesheet" type="text/css" />
                            ...
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message"> Vivamus sed auctor nibh congue nibh. auctor nibh auctor nibh{{url('/')}}. </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message"> Vivamus sed congue nibh auctor nibh congue nibh. auctor nibh auctor nibh{{url('/')}}. </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message"> Vivamus sed nibh auctor nibh congue nibh. auctor nibh auctor nibh{{url('/')}}. </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="message"> Vivamus sed auctor 40% nibh congue nibh{{url('/')}}. </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
...
<div class="page-container page-content-inner page-container-bg-solid">
    ...
    <div class="container-fluid container-lf-space margin-top-30">
                ...
                <div id="carousel-example-generic-v1" class="carousel slide widget-carousel" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <div class="widget-gradient" style="background: url({{url('/')}}/assets/layouts/layout7/img/01.jpg)">
                        ...
                        <div class="item">
                            <div class="widget-gradient" style="background: url({{url('/')}}/assets/layouts/layout7/img/02.jpg)">
                                <div class="widget-gradient-body">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <div class="widget-wrap-img widget-bg-color-white">
                                ...
                                <img class="widget-wrap-img-element img-responsive" src="{{url('/')}}/assets/layouts/layout7/img/iphone.png" alt=""> </div>
                        </div>
                        <div class="item">
                            <div class="widget-wrap-img widget-bg-color-white">
                                <h3 class="widget-wrap-img-title">New Desktop Look</h3>
                                <img class="widget-wrap-img-element img-responsive" src="{{url('/')}}/assets/layouts/layout7/img/mac.png" alt=""> </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content scroller" style="height: 350px;" data-always-visible="1" data-handle-color="#D7DCE2">
                        <div class="tab-pane fade active in" id="tab_1_1">
                            <div class="widget-news margin-bottom-20">
                                <img class="widget-news-left-elem" src="{{url('/')}}/assets/layouts/layout7/img/03.jpg" alt="">
                            ...
                            <div class="widget-news margin-bottom-20">
                                <img class="widget-news-left-elem" src="{{url('/')}}/assets/layouts/layout7/img/04.jpg" alt="">
                                <div class="widget-news-right-body">
                            ...
                            <div class="widget-news margin-bottom-20">
                                <img class="widget-news-left-elem" src="{{url('/')}}/assets/layouts/layout7/img/07.jpg" alt="">
                                <div class="widget-news-right-body">
                            ...
                            <div class="widget-news">
                                <img class="widget-news-left-elem" src="{{url('/')}}/assets/layouts/layout7/img/05.jpg" alt="">
                                <div class="widget-news-right-body">
        ...
        <div class="row widget-row no-space margin-bottom-20">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 no-space">
                <!-- BEGIN WIDGET SOCIALS -->
                <div class="widget-socials widget-gradient" style="background: url({{url('/')}}/assets/layouts/layout7/img/03.jpg)"></div>
                <!-- END WIDGET SOCIALS -->
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 no-space">
                <!-- BEGIN WIDGET SOCIALS -->
        ...
        <div class="row widget-row">
                        ...
                        <div class="scroller" style="height: 350px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                            <div class="widget-media">
                                <div class="widget-media-elements text-center">
                                    <img class="widget-media-avatar circle margin-bottom-15" src="{{url('/')}}/assets/pages/media/users/avatar1.jpg" alt="">
                            ...
                            <div class="widget-media">
                                <div class="widget-media-elements text-center">
                                    <img class="widget-media-avatar circle margin-bottom-15" src="{{url('/')}}/assets/pages/media/users/avatar6.jpg" alt="">
                                    <a class="widget-btn-default circle" href="#">Follow</a>
                                </div>
                                <div class="widget-media-body">
                                    <h4 class="widget-media-body-title">
                            ...
                            <div class="widget-media">
                                <div class="widget-media-elements text-center">
                                    <img class="widget-media-avatar circle margin-bottom-15" src="{{url('/')}}/assets/pages/media/users/avatar5.jpg" alt="">
                                    <a class="widget-btn-default circle" href="#">Follow</a>
                                </div>
                                <div class="widget-media-body">
                                    <h4 class="widget-media-body-title">
                            ...
                            <div class="widget-media">
                                <div class="widget-media-elements text-center">
                                    <img class="widget-media-avatar circle margin-bottom-15" src="{{url('/')}}/assets/pages/media/users/avatar4.jpg" alt="">
                                    <a class="widget-btn-default circle" href="#">Follow</a>
                                </div>
                                <div class="widget-media-body">
                                    <h4 class="widget-media-body-title">
                            ...
                            <div class="widget-media">
                                <div class="widget-media-elements text-center">
                                    <img class="widget-media-avatar circle margin-bottom-15" src="{{url('/')}}/assets/pages/media/users/avatar11.jpg" alt="">
                                    <a class="widget-btn-default circle" href="#">Follow</a>
                                </div>
                                <div class="widget-media-body">
                                    <h4 class="widget-media-body-title">
            ...
            <div class="col-md-4">
                <!-- BEGIN WIDGET BLOG -->
                <div class="widget-blog text-center margin-bottom-20 clearfix" style="height: 442px; padding-top: 120px; background-image: url({{url('/')}}/assets/layouts/layout7/img/07.jpg);">
                ...
                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar3.jpg" alt="{{url('/')}}.">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar1.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar4.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar2.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar6.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar7.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar8.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar9.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar10.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{url('/')}}/assets/layouts/layout/img/avatar11.jpg" alt="{{url('/')}}.">
                            <div class="media-body">
                    ...
                    <div class="page-quick-sidebar-chat-user">
                        ...
                        <div class="page-quick-sidebar-chat-user-form">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Type a message here{{url('/')}}.">
