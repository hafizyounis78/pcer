                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">During the last
                                                                ...
                                                                how has your
                                                                usual
                                                                pain intensity been on a scale from 0 to 10?
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">During the last
                                                                ...
                                                                how has your
                                                                usual
                                                                pain bothersomeness been on a scale from 0 to 10?
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">What is your usual
                                                                pain intensity during rest on a scale from 0 to 10?
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" name="diagnostic_specify"
                                                                       class="form-control"
                                                        ...
                                                        <hr/>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Include Patient in
                                                                project

                                                            </label>
                                                            <div class="col-md-4">
                                                                <select class="form-control" id="project_id{{$row->id}}"
                                                                        name="project_id">
                                                                    <option value="">Select...</option>
                                                                    <?php
                                                                    $selected = '';
                                                        ...
                                                        <!--                                                            <div class="col-md-3">
                                                                ...
                                                                <a href="javascript:;" class="btn btn-icon-only green"
                                                                   onclick="add_patient_to_project({{$row->id}});" {!! $followupDoctor_style !!}>
                                                                    <i class="fa fa-plus"></i>
                                                                </a>
                                                            </div>-->
                                                            @endif
                                                ...
                                                <div class="tab-pane" id="tab_1_1_4_{{$row->id}}">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <h3 class="form-section font-green"> Patient
                                                            History </h3>
                                                        <hr/>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Physical
            ...
            <div class="portlet-body ">
                <form action="" class="form-horizontal" method="post" id="pharm_project_form">
                    <div class="form-body">
                        ...
                        <input id="pain_project_id" name="pain_project_id" type="hidden" value="{{''}}">
                                    <div class="well">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <select class="form-control answer_project_question" disabled>
                                                    <option value="">Select..</option>
                                                    <option value="1">Yes</option>
                                                    <option value="0">No</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control pain_project_chart" id="pain_project_chart"
                                                        disabled>
                                                    <option value="">Select..</option>
                                                    <?php
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <input name="doctor_project_note" type="text"
               class="form-control doctor_note"
               placeholder="Doctor Note" value=""></div>
...
<?php
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <select class="form-control pharm_project_action" id="pharm_project_action">
                <option value="">Select..</option>
<?php
    ...
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            <button type="button" class="btn green"
                    onclick="add_pharm_followup_project({{auth()->user()->user_type_id}});">
                                                Save
                                            </button>
                                            <button type="button"
                                                    class="btn grey-salsa btn-outline"
                                ...
                                <div class="col-md-12">
                                    <div class="table-scrollable table-scrollable-borderless">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody class="tbFollowupProject" id="tbFollowupProject">
                        ...
                        <div class="portlet-body ">
                            <form action="" class="form-horizontal" method="post">
                                <div class="form-body">
                                    ...
                                    &lt;!&ndash;                                    <div class="form-group last">
                                    ...
                                    <div class="tab-pane active" id="tab_doctor_followup">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Doctor Note</label>
                                                <div class="col-md-6">
                                                <textarea name="doc_project_note" id="doc_project_note"
                                                          class="form-control doc_project_note"
                                                          rows="3" placeholder="Drugs or Note"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-actions" id="docProjectDv">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="button" class="btn green"
                                                            onclick="add_doc_project_followup();">Save
                                                    </button>
                                                    <button type="button"
                                                            class="btn grey-salsa btn-outline"
                                                            data-dismiss="modal">
 ...
 */
            ...
            //---------project
            function add_patient_to_project(followup_id) {
                var painFile_id = $('#painFile_id').val()
                var project_id = $('#project_id' + followup_id).val()
            ...
            function add_doc_project_followup(project_id) {
                var painFile_id = $('#painFile_id').val()
                //  var project_id = $('#project_id').val()
                $.ajaxSetup({
                    headers: {
                ...
                bootbox.prompt("What is the patient's symptoms?", function (result) {
                    if (result === null || result == '') {
                        alert("Sorry,Please enter patient symptoms");
                    } else {
                        //alert("Hi <b>"+result+"</b>");
                        $.ajax({
                            type: "POST",
                            url: '{{url('project/add-symptoms')}}',

                            data: {
                                project_id: project_id,
                                painFile_id: painFile_id,
                                doctor_project_action: $('#doctor_project_action').val(),
                                doctor_project_note: $('#doctor_project_note').val(),
                            ...
                            success: function (data) {
                                if (data.success) {
                                    ...
                                    $('.tbpatient_project_followup').html(data.patient_project_followup_html);
                                } else {
                                    alert('error');
                                }
                            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            $('#tbdoc_project_followup').html(data.project_data.doctor_html);
                            $('#tbpharm_project_followup').html(data.project_data.pharm_html);
                        }
                    }
                });//END $.ajax
            }

            /* function pharmacy_project_followup(id) {
            ...
            function add_pharm_followup_project() {
                ...
                if ($('#pharm_project_note').val() == '') {
                    $('.pharm-project-danger').show();
                    $('.pharm-project-danger').fadeOut(2000);
                    $('#pharm_project_note').parent().addClass('has-error');
                    return;
                } else
                    $('#pharm_project_note').parent().removeClass('has-error');
            ...
            function add_doc_followup_project() {
                ...
                if ($('#doc_project_action').val() == '') {
                    $('.doc-project-danger').show();
                    $('.doc-project-danger').fadeOut(2000);
                    $('#doc_project_action').parent().addClass('has-error');
                    return;
                } else
                    $('#doc_project_action').parent().removeClass('has-error');

                if ($('#doc_project_note').val() == '') {
                    $('.doc-project-danger').show();
                    $('.doc-project-danger').fadeOut(2000);
                    $('#doc_project_note').parent().addClass('has-error');
                    return;
                } else
                    $('#doc_project_note').parent().removeClass('has-error');
