    ...
    <div class="page-content">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                {{Form::open(['url'=>url('/project/'.$one_project->id),'class'=>'form-horizontal','method'=>"post","id"=>"project_form"])}}
                {{method_field('put')}}
                <div class="form-body">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <input id="project_name" name="project_name" type="text" class="form-control"
                                       placeholder="project name" value="{{$one_project->project_name}}"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <textarea name="question" id="question" class="form-control"
                                          rows="3" placeholder="Question">{{$one_project->question}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <textarea name="conclusion" id="conclusion" class="form-control"
                                          rows="3" placeholder="Conclusion">{{$one_project->conclusion}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select id="role" name="consequence" class="form-control select2">
                                ...
                                <?php
                                foreach ($consequence_list as $row) {
                                    $selected = '';
                                    if($row->id == $one_project->consequence)
                                        $selected = 'selected';
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <textarea name="consequence_detail" id="consequence_detail" class="form-control"
                                      rows="3" placeholder="Consequence Details">{{$one_project->consequence_detail}}</textarea>
                        </div>
                    </div>
<!--
                    <div class="form-group last">
                        ...
                        <div class="col-md-4">
                            <textarea name="symptoms" id="symptoms" class="form-control"
                                      rows="3" placeholder="Symptoms">{{$one_project->symptoms}}</textarea>
                        </div>
                    </div>
-->
