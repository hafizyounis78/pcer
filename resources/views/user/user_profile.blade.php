...
@extends('admin.layout.index-user')
@section('content')
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon input-group col-md-12">
                                                    ...
                                                    <input name="name" type="text"  class="form-control "
                                                           placeholder="Name"  value="{{$one_user->name}}" disabled> </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-icon input-group col-md-12">
                                                    ...
                                                    <input id="email" name="email" type="email" class="form-control "
                                                           placeholder="email" data-id="{{$one_user->email}}" value="{{$one_user->email}}" disabled> </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
