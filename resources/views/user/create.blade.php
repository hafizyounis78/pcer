            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon input-group col-md-12">
                                ...
                                <i class="fa fa-key"></i>
                                <span class="help-block">at least 6 </span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select id="role" name="user_type_id" class="form-control select2">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input id="daily_capacity" name="daily_capacity" type="text" class="form-control"
                                       placeholder="Capacity" value="0"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="color" id="user_color" name="user_color" class="form-control"></div>
