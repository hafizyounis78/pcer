...
class CreateAcuteNeurologicalExamsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acute_neurological_exams', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('acute_neurological_exams');
    }
}
