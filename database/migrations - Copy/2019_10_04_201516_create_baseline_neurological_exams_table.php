...
class CreateBaselineNeurologicalExamsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('baseline_neurological_exams', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('baseline_neurological_exams');
    }
}
