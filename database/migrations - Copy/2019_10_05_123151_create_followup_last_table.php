...
class CreateFollowupLastTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('followup_last', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('treatment_satisfied')->nullable()->comment('list 0-6');
            $table->integer('overall_status')->nullable()->comment('lookups 120');
    ...
    {
        Schema::dropIfExists('followup_last');
    }
}
