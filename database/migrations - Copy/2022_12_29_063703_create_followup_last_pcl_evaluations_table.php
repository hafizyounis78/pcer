...
class CreateFollowupLastPclEvaluationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('followup_last_pcl_evaluations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('followup_last_pcl_evaluations');
    }
}
