...
class CreateAcutePainLocationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acute_pain_locations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('acute_pain_locations');
    }
}
